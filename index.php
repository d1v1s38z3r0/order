...
<BODY>
	<div class="phppot-container">
		<div class="page-heading">High quality Plastic Barrel ,Drum 200 Litre HDPE Open Top</div>
...
<?php }?>
			...
			<div id="shopping-cart" tabindex="1">
				<div id="tbl-cart">
					<div id="txt-heading">
						<div id="cart-heading">Your Shopping Cart includes Standard Shipping (25-35 day).</div>
						<div id="close"></div>
					</div>
					<div id="cart-item">
				...
				<div class="row">
					<div class="inline-block">
						<div>
							...
							bank transfer
							<div class="info-label">Card Payments and Paypal are available for request only.</div>
						</div>
